...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/PunyaAlby/File-Sharing/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/PunyaAlby/File-Sharing/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
## 🏷 Support   
- Follow Channel [@Ruangprojects](https://t.me/ruangprojects) untuk info Update bot 
- Gabung Group [@RuangDiskusi](https://t.me/ruangdiskusikami) untuk diskusi, pelaporan bug, dan bantuan tentang File-Sharing.
...
[FILE-SHARING-BOT](https://github.com/PunyaAlby/File-Sharing/) is Free Software: You can use, study share and improve it at your
